...
function Footer(props) {
    ...
    return (
        <footer className='p-4 bg-gray-100 sm:p-6 dark:bg-gray-900 relative md:absolute w-full bottom-0'>
            ...
            <div className='sm:flex sm:items-center sm:justify-between'>
                ...
                <div className='flex mt-4 space-x-6 sm:justify-center sm:mt-0'>
                    ...
                    <a href='https://twitter.com/mr_akbari_' className='text-gray-500 hover:text-gray-900 dark:hover:text-white'>
