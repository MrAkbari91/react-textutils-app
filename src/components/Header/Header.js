...
const Header = (props) => {
    ...
    return (
        <>
            <header className='h-16 flex items-center justify-between px-5 bg-gray-00 border-gray-200 dark:bg-gray-900 dark:border-gray-700'>
                <div className='logo'>
                ...
                <div className='navlink flex'>
                    <ul className={Mobile ? "nav-links-mobile dark:bg-gray-900 bg-white" : "link flex items-center"} onClick={() => setMobile(false)}>
                        <li>
                            <Link to='/' className="dark:text-white">{props.home}</Link>
                        </li>
                        <li>
                            <Link to='/binary' className="dark:text-white">{props.about}</Link>
                        </li>
                        <li>
                            <Link to='/features' className="dark:text-white">{props.services}</Link>
                        </li>
                        <li>
                            <Link to='/contact' className="dark:text-white">{props.contact}</Link>
                        </li>
                        {/* <li>
                            <label className="flex relative items-center cursor-pointer">
                                <input type="checkbox" value="" onClick={toggleDarkMode} className="sr-only peer" checked={theme === "dark" ? true : false} />
